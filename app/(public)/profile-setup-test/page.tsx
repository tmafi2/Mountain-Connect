...
export default function ProfileSetupTestPage() {
      ...
      case "Review":
        return (
          <div className="space-y-6">
            ...
            {/* Submit button */}
            <div className="rounded-xl border-2 border-dashed border-secondary bg-secondary/5 p-6 text-center">
              <p className="text-sm font-medium text-primary">
                This is a test preview of the worker profile setup flow.
              </p>
              <p className="mt-1 text-xs text-foreground/50">
                In production, clicking &ldquo;Save Profile&rdquo; will persist your data to Supabase.
              </p>
              <button
                type="button"
                className="mt-4 rounded-lg bg-primary px-8 py-3 text-sm font-medium text-white transition-colors hover:bg-primary/90"
                onClick={() => {
                  alert("Profile saved! (Test mode — no data was actually saved)");
                }}
              >
                Save Profile
              </button>
  ...
  return (
    <div className="mx-auto max-w-4xl px-6 py-10">
      {/* Header */}
      <div className="mb-8">
        <Link href="/" className="text-sm text-foreground/50 hover:text-primary">
          &larr; Back to Home
        </Link>
        <h1 className="mt-3 text-3xl font-bold text-primary">Set Up Your Worker Profile</h1>
