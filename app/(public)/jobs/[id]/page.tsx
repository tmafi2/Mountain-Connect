      ...
      <div className="mx-auto max-w-5xl px-6 py-8">
        <div className="grid gap-8 lg:grid-cols-3">
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            {/* Key Details Strip */}
            <div className="grid grid-cols-2 gap-px overflow-hidden rounded-2xl border border-accent bg-accent/30 sm:grid-cols-4">
              <KeyDetail
              ...
              <KeyDetail
                ...
                label="Applicants"
                value={`${applicantCount ?? 0} applied`}
              />
            </div>
            ...
            <div className="rounded-2xl border border-accent bg-white p-6 shadow-sm">
              ...
              <div className="grid grid-cols-2 gap-4 sm:grid-cols-4">
                ...
                <div className="rounded-xl bg-accent/10 p-3">
                  <p className="text-[10px] font-semibold text-foreground/35 uppercase tracking-wider">Applicants</p>
                  <p className="mt-1 text-sm font-medium text-primary">{applicantCount ?? 0}</p>
                </div>
              </div>
            </div>
          </div>
