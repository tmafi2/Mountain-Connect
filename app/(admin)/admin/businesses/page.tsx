            ...
            {filtered.map((biz) => {
              ...
              return (
                <tr key={biz.id} className="border-b border-accent/30 transition-colors hover:bg-accent/5">
                  ...
                  <td className="px-5 py-3 text-foreground/70">{getCategoryLabel(biz.category)}</td>
                  <td className="px-5 py-3 text-foreground/70">{biz.location}</td>
                  <td className="px-5 py-3">
                    <span className={`inline-flex rounded-full px-2 py-0.5 text-xs font-medium ${style.bg} ${style.text}`}>
                      {style.label}
                    </span>
                  </td>
                  <td className="px-5 py-3 text-right font-medium text-primary">{biz.open_positions}</td>
                </tr>
              );
            })}
          </tbody>
