    ...
    countries: [
      {
        name: "Canada",
        resorts: [
          { id: "69", name: "Asessippi Ski Area" },
          { id: "11", name: "Banff / Lake Louise" },
          { id: "58", name: "Big White Ski Resort" },
          { id: "68", name: "Blue Mountain Resort" },
          { id: "60", name: "Lake Louise Ski Resort" },
          { id: "65", name: "Le Massif de Charlevoix" },
          { id: "63", name: "Marmot Basin" },
          { id: "66", name: "Mont-Sainte-Anne" },
          { id: "64", name: "Mont-Tremblant" },
          { id: "62", name: "Nakiska Ski Area" },
          { id: "15", name: "Revelstoke" },
          { id: "59", name: "Silver Star Mountain Resort" },
          { id: "67", name: "Stoneham Mountain Resort" },
          { id: "57", name: "Sun Peaks Resort" },
          { id: "61", name: "Sunshine Village" },
