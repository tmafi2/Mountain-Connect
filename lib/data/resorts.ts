...
export const resorts: Resort[] = [
  ...
  createResort({
    ...
    region_id: "2",
    country: "Canada",
    // Was "Banff / Lake Louise": not a resort, but the three Banff ski areas
    // added together, while Lake Louise (60) and Sunshine Village (61) already
    // existed separately. See migration 00091.
    description:
      "The closest ski area to the town of Banff, five minutes up the switchbacks and the oldest of the Banff trio — lifts have run here since 1948. Small, steep and quiet next to its neighbours, with the North American chair serving genuinely serious terrain and night skiing on Wednesdays and Fridays through the winter. Staff live in Banff and ride a free shuttle up the hill.",
    latitude: 51.2032,
    longitude: -115.5986,
    ...
    num_lifts: 5,
    lift_types: { gondolas: 0, chairlifts: 4, surface_lifts: 1 },
    snowfall_avg_cm: 300,
    ...
    visa_requirements:
      "International workers typically require a Working Holiday Visa (IEC) for Canada. Australian, UK, French, Irish, and many other nationalities are eligible. Some employers offer LMIA-backed work permits for specialized roles.",
    recruitment_timeline:
      "Hiring opens in July–August for the winter, with most roles filled by late September. Entry-level positions are often placed through working-holiday programmes, and staff housing is confirmed by department managers around mid-September. Late applicants can still find work into November.",
    staff_housing_available: true,
    staff_housing_capacity: null,
    staff_housing_avg_rent:
      "CAD $8–$16.50/day for a shared room (roughly $240–$500/month). All staff housing is in Banff rather than on the hill, with a free staff bus.",
    cost_of_living_weekly: "CAD $300–$450 (housing, food, transport)",
    public_transport:
      "Free staff shuttle from pick-up points around Banff to the hill, about 10 minutes. Roam Transit runs local routes throughout Banff and on to Canmore and Lake Louise. Rider Express coaches to Calgary take roughly 1.5 hours.",
    staff_perks: [
  ...
  // ============================================
  // AUSTRALIA — additions (NSW, VIC, TAS)
  // ============================================
  createResort({
    ...
    base_elevation_m: 1492, summit_elevation_m: 1614,
    season_start: "2026-06-06", season_end: "2026-10-04", snow_reliability: "low",
  ...
  createResort({
    ...
    base_elevation_m: 1320, summit_elevation_m: 1747,
    season_start: "2026-06-06", season_end: "2026-10-04", snow_reliability: "low",
    website: "https://www.mtstirling.com.au",
  }),
  createResort({
    ...
    base_elevation_m: 1450, summit_elevation_m: 1567,
    season_start: "2026-06-06", season_end: "2026-09-13", snow_reliability: "low",
  ...
  createResort({
    ...
    base_elevation_m: 1370, summit_elevation_m: 1480,
    season_start: "2026-06-06", season_end: "2026-09-13", snow_reliability: "low",
    website: "https://www.lakemountainresort.com.au",
  }),
  createResort({
    ...
    base_elevation_m: 1240, summit_elevation_m: 1410,
    season_start: "2026-07-04", season_end: "2026-09-13", snow_reliability: "low",
    website: "https://www.mtmawson.info",
  }),
  createResort({
    ...
    base_elevation_m: 1460, summit_elevation_m: 1572,
    season_start: "2026-07-04", season_end: "2026-09-20", snow_reliability: "low",
    website: "https://www.skibenlomond.com.au",
  }),
  ...
  createResort({
    ...
    base_elevation_m: 1260, summit_elevation_m: 1980,
  ...
  createResort({
    ...
    base_elevation_m: 1500, summit_elevation_m: 1860, snow_reliability: "medium",
    website: "https://www.mtolympus.co.nz",
  }),
  createResort({
    ...
    base_elevation_m: 1500, summit_elevation_m: 1850, snow_reliability: "medium",
    website: "https://www.mtcheeseman.co.nz",
  }),
  createResort({
    ...
    base_elevation_m: 1480, summit_elevation_m: 1820, snow_reliability: "medium",
    website: "https://www.brokenriver.co.nz",
  }),
  createResort({
    ...
    base_elevation_m: 1430, summit_elevation_m: 1980, snow_reliability: "medium",
    website: "https://www.craigieburn.co.nz",
  }),
  createResort({
    ...
    base_elevation_m: 1240, summit_elevation_m: 1980, snow_reliability: "medium",
    website: "https://www.templebasin.co.nz",
  }),
  createResort({
    ...
    base_elevation_m: 1400, summit_elevation_m: 1760, snow_reliability: "low",
    website: "https://www.skihanmer.co.nz",
  }),
  createResort({
    ...
    base_elevation_m: 1400, summit_elevation_m: 1850, snow_reliability: "low",
  ...
  createResort({
    ...
    base_elevation_m: 1640, summit_elevation_m: 2100, snow_reliability: "medium",
  ...
  createResort({
    ...
    base_elevation_m: 850, summit_elevation_m: 1350, snow_reliability: "high",
  ...
  createResort({
    ...
    base_elevation_m: 500, summit_elevation_m: 1304, snow_reliability: "high",
  ...
  createResort({
    ...
    base_elevation_m: 580, summit_elevation_m: 1300, snow_reliability: "high",
  ...
  createResort({
    ...
    base_elevation_m: 1130, summit_elevation_m: 1335, snow_reliability: "medium",
  ...
  createResort({
    ...
    base_elevation_m: 380, summit_elevation_m: 1147, snow_reliability: "high",
  ...
  createResort({
    ...
    base_elevation_m: 1800, summit_elevation_m: 2020, snow_reliability: "high",
  ...
  createResort({
    ...
    base_elevation_m: 660, summit_elevation_m: 1325, snow_reliability: "high",
  ...
  createResort({
    ...
    base_elevation_m: 540, summit_elevation_m: 1100, snow_reliability: "high",
  ...
  // ── BC interior + coast, added 2026-09-20 for the Canadian outreach list ──
  createResort({
    id: "109",
    ...
    country: "Canada",
    description:
      "A locals' mountain in the Selkirks 20km south of Nelson, with a reputation out of all proportion to its size: roughly 12 metres of dry Kootenay snow a year and no snowmaking at all. Three chairs open around 480 hectares of steep trees, bowls and easily reached sidecountry, and the Fresh Tracks Café at the base is a destination in its own right. There is no on-mountain accommodation of any kind — everyone who works here lives in Nelson and rides the ski bus up.",
    latitude: 49.440,
    longitude: -117.150,
    state_province: "British Columbia",
    nearest_town: "Nelson",
    website: "https://whitewatermountainresort.com",
    skiable_terrain_ha: 480,
    num_runs: 82,
    vertical_drop_m: 625,
    base_elevation_m: 1645,
    summit_elevation_m: 2270,
    num_lifts: 4,
    lift_types: { gondolas: 0, chairlifts: 3, surface_lifts: 1 },
    snowfall_avg_cm: 1200,
    season_start: "2026-12-11",
    season_end: "2027-04-04",
    main_employers: [
      "Whitewater Ski Resort",
      "Fresh Tracks Café and the base-area food and beverage operation",
      "Whitewater Snow Sports School",
      "Nelson hospitality (Baker Street restaurants, cafés and hotels)",
      "Cat-ski and backcountry lodges in the surrounding Selkirks",
    ],
    common_jobs: [
      "Lift Operator",
      "Ski/Snowboard Instructor",
    ...
    estimated_seasonal_staff: "150–250",
    languages_required: ["English"],
    visa_requirements:
      "International workers typically arrive on Working Holiday Visas (IEC). Canada has IEC agreements with Australia, the UK, Ireland, France, Germany, Japan and many other countries. Instructor and senior kitchen roles are occasionally sponsored on LMIA-backed permits.",
    recruitment_timeline:
      "Hiring runs August–November for a mid-December opening, and the job is rarely the hard part — housing in Nelson is. Line up a room before you accept, because the resort has none to offer.",
    staff_housing_available: false,
    staff_housing_avg_rent:
      "None on the mountain. Staff rent in Nelson, roughly CAD $900–$1,500/month for a shared room.",
    cost_of_living_weekly: "CAD $375–$525 (Nelson prices, not resort prices)",
    public_transport:
      "The Whitewater ski bus runs from Nelson on operating days and is how most staff get up the hill, so a season without a car is genuinely workable. Otherwise it is a 20km drive up Highway 6. Castlegar airport (YCG) is 45 minutes away but fogs in; Spokane is three hours south.",
    staff_perks: [
      "Free season pass",
      "Discounted food at Fresh Tracks Café",
      "Pro deals on gear",
      "Avalanche awareness and first-aid training",
      "Reciprocal days at other independent BC hills",
    ],
    apres_scene:
      "Coal Oil Johnny's at the base for the first hour, then the hill empties into Nelson — Baker Street's pubs, brewery taprooms and live music carry the season. The Coldsmoke Powder Festival in February is the big date.",
    outdoor_activities: [
      "Ski touring in the Whitewater and Ymir backcountry",
      "Kootenay Pass touring (a short drive east)",
      "Cat skiing with nearby operators",
      "Hot springs at Ainsworth and Nakusp",
      "Ice climbing and snowshoeing",
      "Kootenay Lake swimming and mountain biking in summer",
    ],
    healthcare_access:
      "Kootenay Lake Hospital in Nelson (20 minutes) has an emergency department. Trail's regional hospital, an hour south, handles major care. Ski patrol covers the hill during operations.",
    shops_and_services:
      "Almost nothing on the mountain beyond rentals, retail and the café. Nelson is a full service town — supermarkets, the Kootenay Co-op, banks, pharmacies, gear shops and laundromats.",
    international_community_size:
      "Small. This is a locals' hill first, so the seasonal crowd is a minority — a steady IEC contingent of Aussies, Brits and Europeans mixed into a community of people who moved here for the snow years ago.",
    avg_winter_temp_min_c: -12,
    avg_winter_temp_max_c: -2,
    snow_reliability: "high",
    artificial_snow_coverage_pct: 0,
  ...
  createResort({
    ...
    country: "Canada",
    description:
      "Four mountains above the gold-rush town of Rossland — Red, Granite, Grey and Kirkup — adding up to roughly 1,500 hectares and 890m of vertical. Canada has been skiing here since the 1890s and it still feels like it: no purpose-built village, a heritage main street five minutes below the base, and an unusually cheap single-cat operation on Mt Kirkup that opens another 400 hectares for the price of a lift ticket. Nancy Greene and Kerrin Lee-Gartner both grew up on this hill.",
    latitude: 49.100,
    longitude: -117.830,
    state_province: "British Columbia",
    nearest_town: "Rossland",
    website: "https://www.redresort.com",
    skiable_terrain_ha: 1560,
    num_runs: 119,
    vertical_drop_m: 890,
    base_elevation_m: 1185,
    summit_elevation_m: 2075,
    num_lifts: 8,
    lift_types: { gondolas: 0, chairlifts: 6, surface_lifts: 2 },
    snowfall_avg_cm: 750,
    season_start: "2026-12-05",
    season_end: "2027-04-04",
    main_employers: [
      "RED Mountain Resort",
      "The Josie Hotel at the base",
      "RED Mountain Snow Sports School",
      "Big Red Cats (cat skiing on the surrounding peaks)",
      "Rossland hospitality — pubs, cafés and the brewery",
      "Trail's industrial employers, ten minutes down the hill",
    ],
    common_jobs: [
      "Lift Operator",
      "Ski/Snowboard Instructor",
      ...
      "Guest Services",
      "Hotel Reception / Housekeeping",
      "Cat Ski Guide / Tail Guide",
    ],
    estimated_seasonal_staff: "250–400",
    languages_required: ["English"],
    visa_requirements:
      "Mostly IEC working-holiday workers from Australia, the UK, Ireland and Europe. Instructor roles want CSIA/CASI certification or a recognised equivalent; guiding roles need avalanche qualifications.",
    recruitment_timeline:
      "Hiring runs September–November for an early-December opening. Rossland is small and its housing turns over with the season, so start looking for a room at the same time you apply.",
    staff_housing_available: false,
    staff_housing_avg_rent:
      "No large staff housing programme. Most staff rent in Rossland (CAD $800–$1,400/month shared) or in Trail, ten minutes downhill and noticeably cheaper.",
    cost_of_living_weekly: "CAD $350–$500",
    public_transport:
      "A seasonal shuttle links Rossland and the base, and the hill is close enough that carpooling covers most shifts. Regional transit runs down to Trail and Castlegar. Spokane (GEG), 2.5 hours south, is the airport most international staff actually fly into.",
    staff_perks: [
      "Free season pass",
      "Discounted cat-skiing days",
      "Pro deals on gear",
      "Food and beverage discounts at base-area outlets",
      "Avalanche awareness training",
    ],
    apres_scene:
      "The base bar first, then Columbia Avenue in Rossland — a couple of proper pubs, a brewery taproom and a town small enough that everyone ends up in the same room. Winter Carnival in late January is the season's centrepiece.",
    outdoor_activities: [
      "Cat skiing on Mt Kirkup and with Big Red Cats",
      "Ski touring in the Rossland Range",
      "Nordic trails at Black Jack, right beside the resort",
      "Ice skating and snowshoeing in town",
      "Seven Summits mountain biking in summer",
    ],
    healthcare_access:
      "A health centre in Rossland for day-to-day care; Kootenay Boundary Regional Hospital in Trail, ten minutes away, has the emergency department. Ski patrol covers the hill.",
    shops_and_services:
      "A bank, pharmacy, grocery, hardware and gear shops in Rossland. Trail has the supermarkets and big-box retail. Nothing beyond rentals and food at the base itself.",
    international_community_size:
      "Solid for a hill this size — a reliable Australian, Kiwi, British and European contingent each winter, smaller and less transient than Whistler or Banff.",
    avg_winter_temp_min_c: -12,
    avg_winter_temp_max_c: -3,
    snow_reliability: "high",
    artificial_snow_coverage_pct: 5,
  ...
  createResort({
    ...
    country: "Canada",
    description:
      "1,224m of vertical in the Purcells above Invermere — among the biggest in North America — across roughly 1,200 hectares. A purpose-built ski-in ski-out village sits at the base with hot pools in the middle of it, and the snow is colder and drier than the Kootenay resorts further west, backed by serious snowmaking on the lower mountain. RK Heliski operates out of the village. Staff accommodation is on the hill; the supermarket is 18km down in Invermere.",
    latitude: 50.460,
    longitude: -116.240,
    state_province: "British Columbia",
    nearest_town: "Invermere",
    website: "https://www.panoramaresort.com",
    skiable_terrain_ha: 1204,
    num_runs: 135,
    vertical_drop_m: 1224,
    base_elevation_m: 1160,
    summit_elevation_m: 2384,
    num_lifts: 10,
    lift_types: { gondolas: 0, chairlifts: 6, surface_lifts: 4 },
    snowfall_avg_cm: 500,
    season_start: "2026-12-05",
    season_end: "2027-04-11",
    main_employers: [
      ...
      "Village hotels, lodges and property management companies",
      "Panorama Springs hot pools",
      "Invermere hospitality, 18km down the hill",
    ],
    common_jobs: [
      "Lift Operator",
      "Ski/Snowboard Instructor",
    ...
    languages_required: ["English"],
    visa_requirements:
      "Largely IEC working-holiday staff — Australians, Britons, Irish, French and Germans. Instructor roles want CSIA/CASI certification; heli operations require avalanche and guiding qualifications.",
    recruitment_timeline:
      "Hiring peaks September–November for an early-December opening, and staff accommodation is allocated as part of being hired rather than separately, so applying early is what gets you a bed.",
    staff_housing_available: true,
    staff_housing_capacity: 300,
    staff_housing_avg_rent: "CAD $400–$700/month in resort staff accommodation, deducted from pay",
    cost_of_living_weekly:
      "CAD $300–$450 if you shop in Invermere; considerably more if you eat in the village",
    public_transport:
      "No public bus up the mountain. The resort runs shuttles to Invermere on a schedule, but staff without a car depend on lifts from those who have one. Calgary (YYC) is about three hours east over the Rockies; Cranbrook (YXC) is 150km south.",
    staff_perks: [
      "Free season pass",
      "Access to Panorama Springs hot pools",
      "Subsidised staff accommodation on the hill",
      "Food and beverage discounts in the village",
      "Pro deals on gear",
      "Reciprocal days at partner resorts",
    ],
    apres_scene:
      "Contained and village-shaped — the base bars and restaurants carry the whole scene, with hot pools as the standard end to a shift. Staff accommodation does the rest of the work. Invermere's pubs are 20 minutes down the road.",
    outdoor_activities: [
      "Heli-skiing with RK Heliski from the village",
      "Snowmobiling and backcountry tours with Toby Creek Adventures",
      "Ski touring in the Purcells",
      "Hot springs at Radium and Fairmont",
      "Skating and Nordic trails in the valley",
      "Lake Windermere and golf in summer",
    ],
    healthcare_access:
      "Ski patrol and first aid on the mountain. Invermere & District Hospital, 20 minutes down, has the emergency department; Cranbrook or Calgary handle major care.",
    shops_and_services:
      "One small general store in the village plus rental and retail outlets — expect village prices. Invermere has the supermarkets, banks, pharmacy and everything else.",
    international_community_size:
      "Good for a mid-sized resort. Staff accommodation throws a largely Australian, British and European cohort together, and everyone arrives and leaves at roughly the same time.",
    avg_winter_temp_min_c: -14,
    avg_winter_temp_max_c: -3,
    snow_reliability: "medium",
    artificial_snow_coverage_pct: 30,
  ...
  createResort({
    ...
    main_employers: [
      ...
      "Apex Snow Sports School",
      "Village lodging, chalet rental and property management companies",
      "Base-area restaurants and the pub",
      "Penticton hospitality and the South Okanagan wineries",
    ],
    common_jobs: [
      "Lift Operator",
      "Ski/Snowboard Instructor",
    ...
    estimated_seasonal_staff: "100–200",
    languages_required: ["English"],
    visa_requirements:
      "IEC working-holiday workers make up most of the international staff. Instructor roles want CSIA/CASI certification. The South Okanagan's agricultural season draws a much larger working-holiday population in summer, so year-round arrangements are realistic here.",
    recruitment_timeline:
      "Hiring runs October–November for a mid-December opening. The hill is small, so there are fewer roles than at the big resorts and they fill quietly — apply early and ask about the shuttle if you plan to live in Penticton.",
    staff_housing_available: false,
    staff_housing_avg_rent:
      "A limited amount of village accommodation; most staff rent in Penticton, roughly CAD $800–$1,300/month shared, where winter is the cheap season.",
    cost_of_living_weekly: "CAD $375–$525",
    public_transport:
      "A seasonal ski shuttle runs up from Penticton on operating days; otherwise it is a 45-minute drive up Green Mountain Road, which is a proper winter climb even when the valley below is bare. Penticton has its own airport (YYF); Kelowna (YLW), 65km north, has far more flights.",
    staff_perks: [
      "Free season pass",
      "Pro deals on gear",
      "Food and beverage discounts at base-area outlets",
      "Skating loop and Nordic trails included",
      "Short commute to the Okanagan wine country on days off",
    ],
    apres_scene:
      "Small and village-contained — the pub and a handful of base restaurants, quiet midweek and busy on holidays. Penticton, 45 minutes down, has the proper nightlife.",
    outdoor_activities: [
      "The village skating loop through the trees",
      "Nordic and snowshoe trails on the mountain",
      "Nickel Plate Nordic Centre next door",
      "Okanagan wine touring on days off",
      "Lake swimming, cycling and climbing at Skaha in the shoulder seasons",
    ],
    healthcare_access:
      "Ski patrol on the hill. Penticton Regional Hospital, 45 minutes down the mountain road, has a full emergency department and specialist services.",
    shops_and_services:
      "A small general store and rental and retail outlets in the village. Penticton has every supermarket chain, banks, pharmacies and big-box retail.",
    international_community_size:
      "Small — Apex hires modestly and many staff are Okanagan locals. The international scene here is thinner in winter than at the big BC resorts and much larger in the summer harvest.",
    avg_winter_temp_min_c: -10,
    avg_winter_temp_max_c: -2,
    snow_reliability: "medium",
    artificial_snow_coverage_pct: 10,
  ...
  createResort({
    ...
    country: "Canada",
    description:
      "The largest of Vancouver's three North Shore mountains, half an hour from downtown and the 2010 Olympic venue for freestyle skiing and snowboarding. About 240 hectares of lift-served terrain plus a separate Nordic and snowshoe area at Hollyburn. Maritime snow means big dumps and the occasional midwinter rain event, and there is no ski town here at all — staff live across Metro Vancouver and commute up the hill, which makes it a city job with a mountain attached rather than a resort season.",
    latitude: 49.400,
    longitude: -123.200,
    state_province: "British Columbia",
    nearest_town: "West Vancouver",
    website: "https://www.cypressmountain.com",
    skiable_terrain_ha: 240,
    num_runs: 53,
    vertical_drop_m: 530,
    base_elevation_m: 910,
    summit_elevation_m: 1440,
    num_lifts: 6,
    lift_types: { gondolas: 0, chairlifts: 5, surface_lifts: 1 },
    snowfall_avg_cm: 550,
    season_start: "2026-12-05",
    season_end: "2027-04-06",
    main_employers: [
      "Cypress Mountain (Boyne Resorts)",
      "Cypress Snow Sports School",
      "The Hollyburn Nordic and snowshoe operation",
      "Base-area food and beverage and rental outlets",
      "The mountain shuttle service from Vancouver",
    ],
    common_jobs: [
      "Lift Operator",
      "Ski/Snowboard Instructor",
      ...
      "Rental Shop Technician",
      "Guest Services",
      "Parking and Traffic Attendant",
      "Snowmaker",
      "Snowshoe and Nordic Guide",
    ],
    estimated_seasonal_staff: "400–600",
    languages_required: ["English"],
    visa_requirements:
      "IEC working-holiday workers are common, and because the mountain sits inside a major city, so are students and residents working a second job. Instructor roles want CSIA/CASI certification.",
    recruitment_timeline:
      "Hiring runs October–November, and a good share of roles are part-time or shift-based to suit people already living in the city. Ask about shuttle access and shift times before you accept — the commute is the job's real constraint.",
    staff_housing_available: false,
    staff_housing_avg_rent:
      "None. Staff live across Metro Vancouver, where rent is the highest in Canada — budget CAD $1,200–$1,800/month for a shared room.",
    cost_of_living_weekly: "CAD $500–$700 (Vancouver prices)",
    public_transport:
      "A scheduled winter shuttle runs from downtown Vancouver, Lonsdale Quay and Park Royal, and is how a large share of staff get to work. TransLink covers the city but not the mountain road itself. Vancouver International (YVR) is about an hour away.",
    staff_perks: [
      "Free season pass",
      "Shuttle access from the city",
      "Pro deals on gear",
      "Food and beverage discounts",
      "Reciprocal days at Boyne resorts",
    ],
    apres_scene:
      "A base lodge bar with one of the best city views in skiing, and after that you are in Vancouver — which has more going on than any ski town in the country, and none of the seasonal-worker closeness that comes with one.",
    outdoor_activities: [
      "Nordic skiing and snowshoeing at Hollyburn",
      "Backcountry touring on Hollyburn and Black Mountain",
      "Sea-level hiking and climbing year-round",
      "Squamish and Whistler up the Sea to Sky Highway",
      "Everything a major city offers on days off",
    ],
    healthcare_access:
      "Ski patrol on the mountain, with Lions Gate Hospital in North Vancouver 30 minutes down and the full range of Vancouver hospitals beyond it.",
    shops_and_services:
      "Rentals, retail and food at the base. Everything else is in West and North Vancouver at the bottom of the mountain road, ten minutes away.",
    international_community_size:
      "Large in the city and diffuse on the hill. Staff scatter home to their own neighbourhoods after a shift, so the tight seasonal community of a resort town does not really form here.",
    avg_winter_temp_min_c: -4,
    avg_winter_temp_max_c: 2,
    snow_reliability: "medium",
    artificial_snow_coverage_pct: 30,
  ...
  createResort({
    ...
    summit_elevation_m: 2100,
    num_lifts: 3,
    lift_types: { gondolas: 0, chairlifts: 2, surface_lifts: 1 },
    snowfall_avg_cm: 500,
    season_start: "2026-12-18",
    season_end: "2027-03-21",
    main_employers: [
      "Baldy Mountain Resort",
      "The base lodge food and beverage operation",
      "Baldy Snow Sports School",
      "Oliver and Osoyoos wineries, orchards and hospitality",
    ],
    common_jobs: [
      "Lift Operator",
      "Ski/Snowboard Instructor",
    ...
    estimated_seasonal_staff: "30–60",
    languages_required: ["English"],
    visa_requirements:
      "A small operation, so international hiring is limited and mostly IEC working-holiday workers already in the valley. The South Okanagan's agricultural season is the larger draw — many people work the harvest and ski here in winter.",
    recruitment_timeline:
      "Hiring is late and small, usually November for a mid-December opening. Because operating days are limited outside peak weeks, ask directly about guaranteed hours before relying on this as your only income.",
    staff_housing_available: false,
    staff_housing_avg_rent:
      "None at the resort. Staff live in Oliver or Osoyoos, roughly CAD $700–$1,200/month shared, and winter is the cheap season there.",
    cost_of_living_weekly: "CAD $325–$450 (among the cheapest ski-adjacent living in BC)",
    public_transport:
      "None to the hill — it is a 45-minute drive up a mountain road from Oliver and carpooling is how most people get there. Regional transit links Oliver with Penticton and Osoyoos. Kelowna (YLW) is the nearest airport with real connections, 110km north.",
    staff_perks: [
      "Free season pass",
      "Food and beverage discounts at the lodge",
      "Empty runs — the real perk here",
      "Pro deals on gear",
    ],
    apres_scene:
      "The day lodge, and then home. Oliver has a couple of pubs and winery tasting rooms; Penticton, 40 minutes further, is where a night out actually happens.",
    outdoor_activities: [
      "Snowshoeing and Nordic touring around the resort",
      "Wine touring through the South Okanagan",
      "Lake swimming and cycling from spring",
      "Vineyard and orchard work through the harvest",
    ],
    healthcare_access:
      "Ski patrol on the hill. South Okanagan General Hospital in Oliver is 45 minutes down; Penticton Regional Hospital handles anything larger.",
    shops_and_services:
      "A day lodge, rentals and not much else. Oliver has a supermarket, pharmacy, bank and hardware store.",
    international_community_size:
      "Very small in winter. The valley's international seasonal population is large but agricultural, and it peaks in summer rather than on the hill.",
    avg_winter_temp_min_c: -9,
    avg_winter_temp_max_c: -1,
    snow_reliability: "medium",
    artificial_snow_coverage_pct: 0,
    is_verified: false,
