        ...
        <tr>
          <td style="padding:36px 32px 24px;">
            ...
            <table cellpadding="0" cellspacing="0" style="margin:0 auto 16px;" align="center">
              <tr>
                <td bgcolor="#3b82f6" style="background-color:#3b82f6;background-image:linear-gradient(135deg,#22d3ee,#3b82f6);border-radius:10px;padding:14px 32px;text-align:center;">
