...
export function contractSignedEmail({
  ...
  return {
    subject: `Contract Signed — ${workerName} for ${jobTitle}`,
    html: `
<!DOCTYPE html>
        ...
        <table width="600" cellpadding="0" cellspacing="0" style="background-color:#ffffff;border-radius:16px;overflow:hidden;box-shadow:0 4px 24px rgba(0,0,0,0.06);">
          ...
          <tr>
            <td style="background:linear-gradient(135deg,#0a1e33 0%,#0f2942 40%,#1a3a5c 100%);padding:44px 32px 36px;text-align:center;">
              ...
              <h1 style="margin:0 0 6px;color:#ffffff;font-size:26px;font-weight:800;">Contract Signed</h1>
          ...
          <tr>
            <td style="padding:36px 32px 24px;">
              ...
              <p style="margin:0 0 24px;color:#4e5d6c;font-size:15px;line-height:1.7;">
                <strong>${workerName}</strong> has signed the contract for the <strong>${jobTitle}</strong> position. You can view the signed contract and manage the applicant from your dashboard.
              </p>
