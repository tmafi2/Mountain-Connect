...
export function businessNewJobEmail({ workerName, businessName, jobTitle, jobUrl, location, pay }: BusinessNewJobEmailProps) {
  return {
    ...
    <tr><td align="center">
        <table width="600" cellpadding="0" cellspacing="0" style="background-color:#ffffff;border-radius:16px;overflow:hidden;box-shadow:0 4px 24px rgba(0,0,0,0.06);">
          ...
          <tr><td bgcolor="#0a1e33" style="background-color:#0a1e33;background-image:linear-gradient(135deg,#0a1e33 0%,#0f2942 40%,#1a3a5c 100%);padding:44px 32px 36px;text-align:center;">
              ...
              <h1 style="margin:0 0 6px;color:#ffffff;font-size:26px;font-weight:800;">New Job Alert</h1>
              <p style="margin:0;color:#22d3ee;font-size:13px;font-weight:600;text-transform:uppercase;letter-spacing:2px;">A business you follow just posted</p>
          </td></tr>
              ...
              <table width="100%" cellpadding="0" cellspacing="0" style="margin:0 0 24px;">
                <tr><td style="padding:24px;background-color:#f0fdf9;border-radius:12px;border:1px solid #99f6e4;">
                    ...
                    <table cellpadding="0" cellspacing="0">
                      <tr><td style="padding:3px 0;color:#4e5d6c;font-size:13px;">📍 &nbsp;${location}</td></tr>
                      <tr><td style="padding:3px 0;color:#4e5d6c;font-size:13px;">💰 &nbsp;${pay}</td></tr>
                    </table>
                </td></tr>
              </table>
