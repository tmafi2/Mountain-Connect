        ...
        <table width="600" cellpadding="0" cellspacing="0" style="background-color:#ffffff;border-radius:12px;overflow:hidden;">
          ...
          <tr>
            <td style="padding:32px;">
              <h1 style="margin:0 0 16px;color:#0e2439;font-size:22px;">New Applicant!</h1>
              <p style="margin:0 0 16px;color:#4e5d6c;font-size:15px;line-height:1.6;">
                Hi ${businessName},
              </p>
              <p style="margin:0 0 16px;color:#4e5d6c;font-size:15px;line-height:1.6;">
                Great news! <strong>${workerName}</strong> has applied for your <strong>${jobTitle}</strong> position.
              </p>
              <p style="margin:0 0 24px;color:#4e5d6c;font-size:15px;line-height:1.6;">
                Head over to your applicants portal to review their profile and take action on their application.
              </p>
              <!-- CTA Button -->
              <table cellpadding="0" cellspacing="0" style="margin:0 0 24px;">
                <tr>
                  <td style="background-color:#0e2439;border-radius:8px;padding:14px 28px;">
                    <a href="${applicantsUrl}" style="color:#ffffff;text-decoration:none;font-size:15px;font-weight:600;">
                      Review Applicants
                    </a>
                  </td>
                </tr>
          ...
          <tr>
            <td style="background-color:#f7f9fb;padding:20px 32px;text-align:center;">
              ...
              <p style="margin:0;color:#999999;font-size:11px;">
                You are receiving this email because you have active job listings on Mountain Connect. If you believe this was sent in error, please contact support.
              </p>
            </td>
          </tr>
        </table>
